public class testBanca {
        ...
        public static void main(String[] args) {
            ...
            System.out.println("Banca " + b.getName() + "totale saldi iniziale = " + b.totaleSaldi());
            ...
            System.out.println("Banca " + b.getName() + "totale saldi = " + b.totaleSaldi());
            ...
            System.out.println("Banca " + b1.getName() + " totale saldi iniziale = " + b1.totaleSaldi());
            ...
            System.out.println("Banca " + b1.getName() + " totale saldi = " + b1.totaleSaldi());
